...
int main(int argc, char ** argv){
  ...
  save_values(time_analysis, "../plots/dynamic_array_time_c_alpha_6.3.plot");
  save_values(copy_analysis, "../plots/dynamic_array_copy_c_alpha_6.3.plot");
  save_values(memory_analysis, "../plots/dynamic_array_memory_c_alpha_6.3.plot");
