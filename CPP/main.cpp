...
int main(int argc, char ** argv){
  ...
  time_analysis.save_values("../plots/dynamic_array_time_cpp_alpha_3.plot");
  copy_analysis.save_values("../plots/dynamic_array_copy_cpp_alpha_3.plot");
  memory_analysis.save_values("../plots/dynamic_array_memory_cpp_alpha_3.plot");
