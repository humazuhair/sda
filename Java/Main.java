...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        time_analysis.save_values("../plots/dynamic_array_time_java_alpha_7.plot");
        copy_analysis.save_values("../plots/dynamic_array_copy_java_alpha_7.plot");
	    memory_analysis.save_values("../plots/dynamic_array_memory_java_alpha_7.plot");
    }
}
